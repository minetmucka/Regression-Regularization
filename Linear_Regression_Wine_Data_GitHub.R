...
## Please install "ggally" package: install.packages("ggally") for graphics, extens ggplot2                                                                 #                                                                                          #
#############################################################################################################################################################
...
# What does sep=";" do?
wine.red <- read.csv("C:/Users/muckam/Desktop/DataScienceBootcamp/Datasets/Wine_Quality/redwine.csv", header=T, sep=";")
str(wine.red)
...
wine.red.lm.model <- lm(quality ~ volatile.acidity + residual.sugar + chlorides + total.sulfur.dioxide + sulphates + alcohol, data=wine.red.train)
